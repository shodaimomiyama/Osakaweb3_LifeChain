...
export declare type ContractContextLegacy = EthersContractContext<ContractResolver, ContractResolverEventsContext, ContractResolverEvents>;
...
export declare type ContractResolverEvents = 'AllowedEnvAdded' | 'AllowedEnvRemoved' | 'RoleAdminChanged' | 'RoleGranted' | 'RoleRevoked' | 'SetContract';
...
export declare type ContractResolverMethodNames = 'new' | 'ACCESS_CONTROL_CONTRACT' | 'ADMIN_ROLE' | 'ALLOWLIST_CONTRACT' | 'DEFAULT_ADMIN_ROLE' | 'LIT_TOKEN_CONTRACT' | 'MULTI_SENDER_CONTRACT' | 'PKP_HELPER_CONTRACT' | 'PKP_NFT_CONTRACT' | 'PKP_NFT_METADATA_CONTRACT' | 'PKP_PERMISSIONS_CONTRACT' | 'PUB_KEY_ROUTER_CONTRACT' | 'RATE_LIMIT_NFT_CONTRACT' | 'RELEASE_REGISTER_CONTRACT' | 'STAKING_CONTRACT' | 'addAllowedEnv' | 'getContract' | 'getRoleAdmin' | 'grantRole' | 'hasRole' | 'removeAllowedEnv' | 'renounceRole' | 'revokeRole' | 'setAdmin' | 'setContract' | 'supportsInterface' | 'typeAddresses';
...
export interface ContractResolver {
     ...
     */
    'new'(env: BigNumberish, overrides?: ContractTransactionOverrides): Promise<ContractTransaction & TransactionRequest>;
    /**
     * Payable: false
     * Constant: true
     ...
     * @param env Type: uint8, Indexed: false
     */
    addAllowedEnv(env: BigNumberish, overrides?: ContractTransactionOverrides): Promise<ContractTransaction & TransactionRequest>;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
     ...
     * @param env Type: uint8, Indexed: false
     */
    getContract(typ: Arrayish, env: BigNumberish, overrides?: ContractCallOverrides): Promise<string>;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
     ...
     * @param env Type: uint8, Indexed: false
     */
    removeAllowedEnv(env: BigNumberish, overrides?: ContractTransactionOverrides): Promise<ContractTransaction & TransactionRequest>;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
     ...
     */
    setAdmin(newAdmin: string, overrides?: ContractTransactionOverrides): Promise<ContractTransaction & TransactionRequest>;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
     ...
     */
    setContract(typ: Arrayish, env: BigNumberish, addr: string, overrides?: ContractTransactionOverrides): Promise<ContractTransaction & TransactionRequest>;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
     ...
     */
    typeAddresses(parameter0: Arrayish, parameter1: BigNumberish, overrides?: ContractCallOverrides): Promise<string>;
}
