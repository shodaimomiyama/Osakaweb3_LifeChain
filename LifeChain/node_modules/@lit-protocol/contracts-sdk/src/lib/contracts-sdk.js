...
const AccessControlConditions_data_1 = require("../abis/AccessControlConditions.data");
const Allowlist_data_1 = require("../abis/Allowlist.data");
const ContractResolver_data_1 = require("../abis/ContractResolver.data");
const LITToken_data_1 = require("../abis/LITToken.data");
const Multisender_data_1 = require("../abis/Multisender.data");
const PKPHelper_data_1 = require("../abis/PKPHelper.data");
const PKPNFT_data_1 = require("../abis/PKPNFT.data");
const PKPPermissions_data_1 = require("../abis/PKPPermissions.data");
const PubkeyRouter_data_1 = require("../abis/PubkeyRouter.data");
const RateLimitNFT_data_1 = require("../abis/RateLimitNFT.data");
const Staking_data_1 = require("../abis/Staking.data");
// ----- autogen:imports:end  -----
...
class LitContracts {
    ...
    constructor(args) {
        ...
        this.connect = async () => {
            ...
            if ((0, misc_1.isBrowser)() && !this.signer) {
            ...
            //          SETTING UP SIGNER
            // =====================================
            if ((!this.privateKey && this.randomPrivateKey) ||
                ...
                if (this.options?.storeOrUseStorageKey) {
                    console.warn("You've set the option to store your private key in local storage.");
  ...
  // ***********************************************************************************************
        `);
            ...
            this.accessControlConditionsContract = {
                read: new ethers_1.ethers.Contract(AccessControlConditions_data_1.accessControlConditions.address, AccessControlConditions_data_1.accessControlConditions.abi, this.provider),
                write: new ethers_1.ethers.Contract(AccessControlConditions_data_1.accessControlConditions.address, AccessControlConditions_data_1.accessControlConditions.abi, this.signer)
            };
            this.allowlistContract = {
                read: new ethers_1.ethers.Contract(Allowlist_data_1.allowlist.address, Allowlist_data_1.allowlist.abi, this.provider),
                write: new ethers_1.ethers.Contract(Allowlist_data_1.allowlist.address, Allowlist_data_1.allowlist.abi, this.signer)
            };
            this.contractResolverContract = {
                read: new ethers_1.ethers.Contract(ContractResolver_data_1.contractResolver.address, ContractResolver_data_1.contractResolver.abi, this.provider),
                write: new ethers_1.ethers.Contract(ContractResolver_data_1.contractResolver.address, ContractResolver_data_1.contractResolver.abi, this.signer)
            };
            this.litTokenContract = {
                read: new ethers_1.ethers.Contract(LITToken_data_1.litToken.address, LITToken_data_1.litToken.abi, this.provider),
                write: new ethers_1.ethers.Contract(LITToken_data_1.litToken.address, LITToken_data_1.litToken.abi, this.signer)
            };
            this.multisenderContract = {
                read: new ethers_1.ethers.Contract(Multisender_data_1.multisender.address, Multisender_data_1.multisender.abi, this.provider),
                write: new ethers_1.ethers.Contract(Multisender_data_1.multisender.address, Multisender_data_1.multisender.abi, this.signer)
            };
            this.pkpHelperContract = {
                read: new ethers_1.ethers.Contract(PKPHelper_data_1.pkpHelper.address, PKPHelper_data_1.pkpHelper.abi, this.provider),
                write: new ethers_1.ethers.Contract(PKPHelper_data_1.pkpHelper.address, PKPHelper_data_1.pkpHelper.abi, this.signer)
            };
            this.pkpNftContract = {
                read: new ethers_1.ethers.Contract(PKPNFT_data_1.pkpNft.address, PKPNFT_data_1.pkpNft.abi, this.provider),
                write: new ethers_1.ethers.Contract(PKPNFT_data_1.pkpNft.address, PKPNFT_data_1.pkpNft.abi, this.signer)
            };
            this.pkpPermissionsContract = {
                read: new ethers_1.ethers.Contract(PKPPermissions_data_1.pkpPermissions.address, PKPPermissions_data_1.pkpPermissions.abi, this.provider),
                write: new ethers_1.ethers.Contract(PKPPermissions_data_1.pkpPermissions.address, PKPPermissions_data_1.pkpPermissions.abi, this.signer)
            };
            this.pubkeyRouterContract = {
                read: new ethers_1.ethers.Contract(PubkeyRouter_data_1.pubkeyRouter.address, PubkeyRouter_data_1.pubkeyRouter.abi, this.provider),
                write: new ethers_1.ethers.Contract(PubkeyRouter_data_1.pubkeyRouter.address, PubkeyRouter_data_1.pubkeyRouter.abi, this.signer)
            };
            this.rateLimitNftContract = {
                read: new ethers_1.ethers.Contract(RateLimitNFT_data_1.rateLimitNft.address, RateLimitNFT_data_1.rateLimitNft.abi, this.provider),
                write: new ethers_1.ethers.Contract(RateLimitNFT_data_1.rateLimitNft.address, RateLimitNFT_data_1.rateLimitNft.abi, this.signer)
            };
            this.stakingContract = {
                read: new ethers_1.ethers.Contract(Staking_data_1.staking.address, Staking_data_1.staking.abi, this.provider),
                write: new ethers_1.ethers.Contract(Staking_data_1.staking.address, Staking_data_1.staking.abi, this.signer)
            };
            // ----- autogen:init:end  -----
            this.connected = true;
        };
        ...
        this.utils = {
            ...
            getMultihashFromBytes: (byte32) => {
                ...
                const multihash = bs58_1.default.encode(Buffer.from(`1220${digest}`, 'hex'));
                return multihash;
            },
            /**
             * Partition multihash string into object representing multihash
             ...
             * @returns {Multihash}
             */
            getBytes32FromMultihash: (ipfsId) => {
            ...
            timestamp2Date: (timestamp) => {
                ...
                let timestampFormatted = new Date(parseInt(timestamp) * 1000);
                return date.format(timestampFormatted, format);
            },
        };
        this.pkpNftContractUtil = {
            read: {
                /**
                 * (IERC721Enumerable)
                 *
                ...
                getTokensByAddress: async (ownerAddress) => {
                    if (!this.connected) {
                        throw new Error('Contracts are not connected. Please call connect() first');
                    }
                ...
                getTokensInfoByAddress: async (ownerAddress) => {
                    const tokenIds = await this.pkpNftContractUtil.read.getTokensByAddress(ownerAddress);
                    const arr = [];
                    // for each pkp
                    for (let i = 0; i < tokenIds.length; i++) {
                        const tokenId = tokenIds[i];
                        const pubKey = await this.pkpNftContract.read.getPubkey(tokenId);
                        const addrs = await (0, addresses_1.addresses)({
                            pkpTokenId: tokenId,
                            publicKey: pubKey,
                        });
                        arr.push(addrs);
            ...
            write: {
                mint: async () => {
                    ...
                    if (this.isPKP) {
                        ...
                        sentTx = await this.signer.sendTransaction(signedTx);
                    }
                    else {
        ...
        this.pkpPermissionsContractUtil = {
            read: {
                /**
                 *
                ...
                getPermittedAddresses: async (tokenId) => {
                    ...
                    while (tries < maxTries) {
                        try {
                            addresses =
                                await this.pkpPermissionsContract.read.getPermittedAddresses(tokenId);
                ...
                getPermittedActions: async (tokenId) => {
                    ...
                    while (tries < maxTries) {
                        try {
                            actions =
                                await this.pkpPermissionsContract.read.getPermittedActions(tokenId);
                            if (actions.length <= 0) {
                                await new Promise((resolve) => setTimeout(resolve, 1000));
                                tries++;
                                continue;
            ...
            write: {
                ...
                addPermittedAction: async (pkpId, ipfsId) => {
                    ...
                    const tx = await this.pkpPermissionsContract.write.addPermittedAction(tokenId, ipfsIdBytes, []);
                ...
                addPermittedAddress: async (pkpId, ownerAddress) => {
                    ...
                    this.log('[addPermittedAddress] input<pkpId>:', pkpId);
                    const tx = await this.pkpPermissionsContract.write.addPermittedAddress(pkpId, ownerAddress, []);
                ...
                revokePermittedAction: async (pkpId, ipfsId) => {
                    ...
                    const tx = await this.pkpPermissionsContract.write.removePermittedAction(pkpId, ipfsHash);
                    this.log('[revokePermittedAction] output<tx>:', tx);
                    return tx;
                },
            },
        };
        this.rateLimitNftContractUtil = {
            read: {
                /**
                ...
                getTokensByOwnerAddress: async (ownerAddress) => {
                    ...
                    const tokens = await (0, exports.asyncForEachReturn)([...new Array(total)], async (_, i) => {
                        if (!this.rateLimitNftContract) {
                            throw new Error('Contract is not available');
                        }
                        ...
                        const URI = await this.rateLimitNftContractUtil.read.getTokenURIByIndex(tokenIndex);
                        const capacity = await this.rateLimitNftContractUtil.read.getCapacityByIndex(tokenIndex);
            ...
            write: {
                ...
                transfer: async ({ fromAddress, toAddress, RLITokenAddress, }) => {
                    ...
                    const tx = await this.rateLimitNftContract.write.safeTransferFrom(fromAddress, toAddress, RLITokenAddress);
                    this.log('tx:', tx);
                    // const res = await tx.wait();
                    // return {
                    //     tx,
