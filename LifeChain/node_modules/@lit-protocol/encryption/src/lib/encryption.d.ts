import { AcceptedFileType, DecryptFileProps, DecryptZipFileWithMetadata, DecryptZipFileWithMetadataProps, EncryptedFile, EncryptedString, EncryptedZip, EncryptFileAndZipWithMetadataProps, EncryptToIpfsProps, DecryptFromIpfsProps, IJWT, SymmetricKey, ThreeKeys, VerifyJWTProps } from '@lit-protocol/types';
 ...
 *
 */
export declare const encryptToIpfs: ({ authSig, sessionSigs, accessControlConditions, evmContractConditions, solRpcConditions, unifiedAccessControlConditions, chain, string, file, litNodeClient, infuraId, infuraSecretKey, }: EncryptToIpfsProps) => Promise<string>;
/**
 *
 ...
 *
 */
export declare const decryptFromIpfs: ({ authSig, sessionSigs, ipfsCid, litNodeClient, }: DecryptFromIpfsProps) => Promise<string | Uint8Array>;
/**
 *
 ...
 */
export declare const decryptZip: (encryptedZipBlob: AcceptedFileType, symmKey: SymmetricKey) => Promise<{
 ...
 *
 */
export declare const encryptFileAndZipWithMetadata: ({ authSig, sessionSigs, accessControlConditions, evmContractConditions, solRpcConditions, unifiedAccessControlConditions, chain, file, litNodeClient, readme, }: EncryptFileAndZipWithMetadataProps) => Promise<ThreeKeys>;
/**
 *
 ...
 */
export declare const decryptZipFileWithMetadata: ({ authSig, sessionSigs, file, litNodeClient, additionalAccessControlConditions, }: DecryptZipFileWithMetadataProps) => Promise<DecryptZipFileWithMetadata | undefined>;
/**
 *
 ...
 */
export declare const decryptFile: ({ file, symmetricKey, }: DecryptFileProps) => Promise<Uint8Array>;
declare global {
    var wasmExports: any;
    var wasmECDSA: any;
 ...
 */
export declare const verifyJwt: ({ jwt }: VerifyJWTProps) => IJWT;
