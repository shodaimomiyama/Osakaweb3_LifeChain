 ...
 *
 */
const encryptFileAndZipWithMetadata = async ({ authSig, sessionSigs, accessControlConditions, evmContractConditions, solRpcConditions, unifiedAccessControlConditions, chain, file, litNodeClient, readme, }) => {
    // -- validate
    const paramsIsSafe = (0, params_validators_1.safeParams)({
 ...
 */
const decryptZipFileWithMetadata = async ({ authSig, sessionSigs, file, litNodeClient, additionalAccessControlConditions, }) => {
    // -- validate
    const paramsIsSafe = (0, params_validators_1.safeParams)({
    ...
    try {
        ...
        if (e.errorCode === 'NodeNotAuthorized' ||
