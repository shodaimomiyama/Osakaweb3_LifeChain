 ...
 */
export declare const checkAndSignAuthMessage: ({ chain, resources, switchChain, expiration, uri, cosmosWalletType, walletConnectProjectId, }: AuthCallbackParams) => Promise<AuthSig>;
