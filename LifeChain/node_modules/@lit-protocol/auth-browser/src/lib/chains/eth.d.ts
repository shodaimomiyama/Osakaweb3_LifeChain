 ...
 * @returns
 */
export declare const checkAndSignEVMAuthMessage: ({ chain, resources, switchChain, expiration, uri, walletConnectProjectId, }: AuthCallbackParams) => Promise<AuthSig>;
/**
 * @browserOnly
 ...
 * @returns { AuthSig }
 */
export declare const signAndSaveAuthMessage: ({ web3, account, chainId, resources, expiration, uri, }: signAndSaveAuthParams) => Promise<AuthSig>;
/**
 * @browserOnly
 * Sign Messags
 *
