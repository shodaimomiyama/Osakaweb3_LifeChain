...
export interface ILitNodeClient {
     ...
     *
     */
    handleNodePromises(nodePromises: Array<Promise<any>>): Promise<SuccessNodePromises | RejectedNodePromises>;
    /**
     *
     * Throw node error
     *
     ...
     */
    getSignedChainDataToken(params: SignedChainDataToken): Promise<string | undefined>;
    /**
     *
     ...
     *
     */
    getSignedToken(params: JsonSigningRetrieveRequest): Promise<string | undefined>;
    /**
     *
     ...
     *
     */
    saveSigningCondition(params: JsonStoreSigningRequest): Promise<boolean | undefined>;
    /**
     *
     ...
     * @returns { Promise<string> }
     */
    validateAndSignEcdsa(params: ValidateAndSignECDSA): Promise<string | undefined>;
    /**
     *
