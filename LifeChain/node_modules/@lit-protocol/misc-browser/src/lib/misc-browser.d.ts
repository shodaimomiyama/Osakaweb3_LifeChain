 ...
 * @param { string } key
 */
export declare const getStorageItem: (key: string) => IEither;
/**
 *
 ...
 */
export declare const setStorageItem: (key: string, value: string) => IEither;
/**
 *
 ...
 */
export declare const removeStorageItem: (key: string) => IEither;
/**
