 ...
 */
export declare function newSessionCapabilityObject(att?: AttenuationsObject, prf?: Array<CID>): ISessionCapabilityObject;
export declare function decode(encoded: string): ISessionCapabilityObject;
