...
import { Chain, AuthSig, NodeClientErrorV0, NodeClientErrorV1, NodeErrorV0, NodeErrorV1 } from '@lit-protocol/types';
/**
 *
 ...
 *
 */
export declare const throwErrorV1: ({ errorKind, details, status, message, errorCode, }: NodeClientErrorV1) => never;
...
export declare const isNodeErrorV1: (nodeError: NodeErrorV0 | NodeErrorV1) => nodeError is NodeErrorV1;
export declare const isNodeErrorV0: (nodeError: NodeErrorV0 | NodeErrorV1) => nodeError is NodeErrorV0;
declare global {
    var litConfig: any;
    var wasmExport: any;
    var wasmECDSA: any;
