 ...
 *
 */
const throwErrorV1 = ({ errorKind, details, status, message, errorCode, }) => {
    const errConstructorFunc = function (errorKind, status, details, message, errorCode) {
        this.message = message;
    ...
    throw new errConstructorFunc(errorKind, status, details, message, errorCode);
};
...
const isNodeErrorV1 = (nodeError) => {
    return (nodeError.hasOwnProperty('errorCode') &&
        nodeError.hasOwnProperty('errorKind'));
};
exports.isNodeErrorV1 = isNodeErrorV1;
const isNodeErrorV0 = (nodeError) => {
    return nodeError.hasOwnProperty('errorCode');
};
exports.isNodeErrorV0 = isNodeErrorV0;
