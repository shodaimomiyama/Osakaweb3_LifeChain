...
class NodeProvenance extends provenance_1.Provenance {
    ...
    uploadFile(path, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.irys.uploadFile(path, Object.assign(Object.assign({}, opts), { upload: Object.assign({}, opts === null || opts === void 0 ? void 0 : opts.upload) }));
        });
    }
    uploadFolder(path, { batchSize = 10, keepDeleted = true, indexFile, interactivePreflight, logFunction, manifestTags, itemOptions, } = { batchSize: 10, keepDeleted: true }) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.irys.uploadFolder(path, {
                ...
                logFunction,
                manifestTags,
                itemOptions: Object.assign(Object.assign({}, itemOptions), { upload: Object.assign({}, itemOptions === null || itemOptions === void 0 ? void 0 : itemOptions.upload) }),
            });
        });
    }
}
