...
const multiAptos_1 = __importDefault(require("./multiAptos"));
function getTokenConfig(Irys, token, wallet, url, providerUrl, contractAddress, opts) {
    switch (token) {
        ...
        case "fantom":
            return new ethereum_1.default({ irys: Irys, name: "fantom", ticker: "FTM", providerUrl: providerUrl !== null && providerUrl !== void 0 ? providerUrl : "https://rpc.ftm.tools/", wallet, opts });
        case "solana":
        ...
        case "kyve": {
            ...
            k.getGas = () => __awaiter(this, void 0, void 0, function* () {
                return [new bignumber_js_1.default(100), 1e18];
            });
        ...
        case "algorand": {
            return new algorand_1.default({
                ...
                wallet,
                opts: Object.assign({ indexerUrl: "https://mainnet-idx.algonode.cloud" }, opts),
            });
        }
        case "aptos": {
            return new aptos_1.default({
                ...
                name: "aptos",
                ticker: "APTOS",
                providerUrl: providerUrl !== null && providerUrl !== void 0 ? providerUrl : "https://fullnode.mainnet.aptoslabs.com",
                wallet,
                opts,
            });
        }
        case "multiaptos": {
            return new multiAptos_1.default({
                ...
                name: "aptos",
                ticker: "APTOS",
                providerUrl: providerUrl !== null && providerUrl !== void 0 ? providerUrl : "https://fullnode.mainnet.aptoslabs.com/v1",
                wallet,
                opts,
            });
        }
