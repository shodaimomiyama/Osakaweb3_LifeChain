...
class GraphQLQuery {
    constructor({ url, retryConfig, query, queryName, opts, }) {
        ...
        if (queryName.includes("arweave") && this.gqlURL.host === "node1.irys.xyz")
            this.gqlURL = new URL("https://arweave.net/graphql");
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                res = yield (0, async_retry_1.default)((_) => __awaiter(this, void 0, void 0, function* () {
                    const r = yield (0, axios_1.default)(this.gqlURL.toString(), {
                        method: "post",
